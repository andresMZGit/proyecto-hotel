...
<body>
    ...
    <nav>
        <div id="navHotelCont" class="container_menu">
            ...
            <div id="opciones_menu" class="opciones_menu">
                ...
                <a class="opcion active" href="#"><i class="fas fa-cash-register icon_opcion"></i><span class="text_opcion">Check Out</span></a>
    ...
    <main class="main_admin">        
        <section id="updateContend" class="container_main">
            <div class="header_main">
                <h2 class="title_apar">Check Out</h2>
                <p>Salida de Clientes</p>
            </div>   
            <article class="hab_out">
                <div id="hab_exit" class="groups-hab">                                      
                </div>
            </article>
        </section>
    </main>
